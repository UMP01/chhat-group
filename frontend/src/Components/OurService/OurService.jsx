    ...
    <div className="lg:w-1/3 px-5 py-3">
        <div className="shadow-md rounded-lg border border-gray-100 overflow-hidden py-5 hover:scale-105 duration-300 hover:shadow-2xl">
            ...
            <div className="px-5 py-1">
                ...
                <p className="text-gray-500 line-clamp-4 text-sm sm:text-sm md:text-base lg:text-base font-medium">
                    {description}
                </p>
                <Link
                    className="primary-color font-medium text-sm sm:text-sm md:text-base lg:text-base inline-flex items-center pt-3 border-b-2 border-cyan-500 hover:translate-x-3 duration-200 cursor-pointer"
                    to={link}
                >
