    ...
    return (
        <div className="p-4 max-w-xl mx-auto">
            ...
            <form>
                ...
                <button className="inline-flex items-center px-10 py-2 primary-bg-color text-white rounded-md hover:bg-gray-100 hover:text-cyan-500 transition delay-900 duration-500 ease-in-out">
